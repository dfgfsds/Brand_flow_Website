    ...
    return (
        <section className=" pt-5 pb-10 m-4">
            <div className="max-w-7xl mx-auto container bg-gray-200 p-4 rounded-md">
                ...
                <div className="font-bold text-3xl text-center py-2 text-blue-500">Brand Flow</div>
                <div className="text-md text-gray-700 px-1 leading-relaxed">
                    <strong>Brand Flow</strong> was founded by with a passion for redefining
                    ...
                    <br /><br />
                    Built on a foundation of <span className="font-semibold">quality, trust, and customer care</span>, Brand Flow aims to
                    ...
                    <br /><br />
                    Under the dedicated leadership of , Brand Flow continues to evolve as a
