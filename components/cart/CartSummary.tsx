...
//                 className="text-yellow-500 border-red-300 hover:bg-red-50"
//               >
//                 Remove Coupon
//               </button> 
//             </div> */}
...
//                 />
//                 <button disabled={!code || isChecking} onClick={handleSubmit} className="whitespace-nowrap bg-blue-900 p-2 rounded-md text-white font-bold hover:bg-red-700">
  ...
  const handleCouponSubmit = async (e: any) => {
    ...
    try {
      ...
      if (typeof err === "string") {
        ...
        errorMessage = err[0]?.string || errorMessage;
