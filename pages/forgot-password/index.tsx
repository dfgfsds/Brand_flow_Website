          ...
          <div>
            {!showPasswordReset && (
              <form onSubmit={handleEmailSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full gap-2 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-900 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  disabled={emailLoader}
                >
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white w-full max-w-md p-6 rounded shadow-lg relative">
                  ...
                  <div className="text-center text-sm text-gray-500 mb-4 cursor-pointer">
                    {timer === 0 ? (
                      <>
                        <span className="cursor-pointer text-blue-900 font-bold" onClick={sendOtpToEmail}>Resend</span>
                      </>
                    ) : (
                      <>
                  ...
                  <div className="flex justify-between">
                    <button
                      ...
                      className="w-full cursor-pointer  bg-blue-900 text-white py-2 rounded hover:bg-blue-800"
                      disabled={optLoader}
                    >
            ...
            {showPasswordReset && (
              <form onSubmit={handlePasswordReset} className="space-y-5 mt-6">
                ...
                {confirmPassword && newPassword !== confirmPassword && (
                  <p className="text-sm text-blue-600 text-center mb-4">Passwords do not match. Please enter matching passwords.</p>

                )}
                <button
                  type="submit"
                  className="w-full bg-blue-900 text-white py-2 rounded-md hover:bg-blue-800 disabled:cursor-not-allowed"
