                    ...
                    <div>
                        ...
                        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-300 p-4 md:hidden">
                            <div className="flex items-center justify-between gap-1 flex-wrap">
                                ...
                                {/* Buy Now Button */}
                                <button
                                    className="flex bg-blue-900 text-white py-3 px-2 rounded-lg shadow-lg hover:bg-red-700 flex items-center justify-center gap-2"
                                    onClick={() => setMobileModal(true)}
                                >
                                    <ShoppingBasket size={18} /> Buy Now
                                </button>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center px-4">
                        <div className="bg-white w-full max-w-md p-6 rounded shadow-lg relative">
                            ...
                            <form onSubmit={handleMobileSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-blue-900 text-white py-2 rounded hover:bg-red-700"
                        ...
                        {(!userExists || address?.data?.length === 0 || isAddingNewAddress) ? (
                            <>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full text-center bg-blue-900 text-white py-2 rounded hover:bg-red-700"
                                    >
                            ...
                            <>
                                ...
                                <button className="w-full mt-10 p-2 flex gap-2 justify-center bg-blue-900 cursor-pointer hover:bg-red-700 text-white font-bold" onClick={handleCheckout}>Proceed to Checkout</button>
